...
class SpaceCatsControllerTest < ActionController::TestCase
  ...
  test "should update space_cat" do
    patch :update, id: @space_cat, space_cat: { integer: @space_cat.integer, name: @space_cat.name, planet: @space_cat.planet, planets_visited: @space_cat.planets_visited, string: @space_cat.string, string: @space_cat.string }
    assert_redirected_to space_cat_path(assigns(:space_cat))
  end
